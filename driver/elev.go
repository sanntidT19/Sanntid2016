...
const N_BUTTONS = 3
var N_FLOORS int //is this required here? should this be all caps?
...
func Elev_set_n_floors(num int){
	N_FLOORS = num
}
...
func Elev_init() error {
	...
	for i :=0;  i<N_FLOORS; i++ {
		if i != 0 {
			elev_set_button_lamp(DOWN, i , false)
		}
		if i != N_FLOORS-1 {
			elev_set_button_lamp(UP, i, false)
		}
		elev_set_button_lamp(COMMAND, i, false)
	}
